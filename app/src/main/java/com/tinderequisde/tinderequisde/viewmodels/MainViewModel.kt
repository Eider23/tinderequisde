package com.tinderequisde.tinderequisde.viewmodels
...
class MainViewModel : ViewModel() {
    ...
    val profiles by lazy { MutableLiveData<List<ProfileInfo>>() }
    ...
    private val descriptions = listOf(
        "Hola, soy Juan, me gustan los deportes. Soy cheff y puedo prepararte los platillos que mas te gusten!",
        "Pepe, soy fisicoCulturista aunque no parezca jeje.",
        "Atractivo no soy, pero igual te interesa descubrir si soy simpático",
        "¿Te gustan las chicas malas? Yo soy mala en todo. Hasta jugando al parchís",
        ...
        "Haciendo simplemente una cosa, que se llama: LO QUE ME DA LA GANA"
    )
